...
- (NSDictionary *)options
{
    ...
    if ([self.annotation title] && [self.annotation subtitle])
    {
        [options setObject:[NSString stringWithFormat:@"%@ <br> %@",[self.annotation title],[self.annotation subtitle]] forKey:@"title"];
    }
    else if ([self.annotation title])
